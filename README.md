...
| **Tablero Kanban** | Gestión visual de tareas por estado (`Pendiente`, `En Progreso`, `En Revisión`, `Completada`, `Blocked`). | Claridad en el progreso, facilita la priorización y el seguimiento. |
