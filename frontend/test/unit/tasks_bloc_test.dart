  ...
  group('TasksBloc', () {
    ...
    group('TasksLoadRequested', () {
      blocTest<TasksBloc, TasksState>(
        ...
        verify: (_) {
          verify(mockTasksService.getProjectTasksForUser(1)).called(1);
        },
      );
      ...
      blocTest<TasksBloc, TasksState>(
        ...
        act: (bloc) => bloc.add(const TasksLoadRequested(projectId: 1)),
        expect: () => [isA<TasksLoading>(), isA<TasksFailure>()],
        verify: (_) {
          verify(mockTasksService.getProjectTasksForUser(1)).called(1);
        },
      );
    ...
    group('TaskCreateRequested', () {
      blocTest<TasksBloc, TasksState>(
        ...
        build: () {
          ...
          when(
            mockTasksService.createTask(any),
    ...
    group('TaskUpdateRequested', () {
      blocTest<TasksBloc, TasksState>(
        ...
        build: () {
          ...
          when(
            mockTasksService.updateTask(1, any),
          ).thenAnswer((_) async => testTask);
          // Mock getTasksByProject para la recarga automática
          when(
            mockTasksService.getProjectTasksForUser(1),
