-- =====================================================
-- ROLLBACK: Deshabilitar RLS en tabla comments
-- Sistema de Seguimiento de Proyectos TFG - Ciclo DAM
-- =====================================================
-- Fecha: 2025-01-19
-- Propósito: Revertir habilitación de RLS en tabla comments
...
DROP POLICY IF EXISTS "Development access to comments" ON comments;
...
DO $$
BEGIN
    RAISE NOTICE 'RLS deshabilitado exitosamente en tabla comments';
