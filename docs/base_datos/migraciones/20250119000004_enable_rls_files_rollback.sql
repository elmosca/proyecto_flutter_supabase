-- =====================================================
-- ROLLBACK: Deshabilitar RLS en tabla files
-- Sistema de Seguimiento de Proyectos TFG - Ciclo DAM
-- =====================================================
-- Fecha: 2025-01-19
-- Propósito: Revertir habilitación de RLS en tabla files
...
DROP POLICY IF EXISTS "Development access to files" ON files;
...
DO $$
BEGIN
    RAISE NOTICE 'RLS deshabilitado exitosamente en tabla files';
