...
class AppConfigLocal {
  ...
  // URLs de servicios
  static const String supabaseStudioUrl = 'https://supabase.com/dashboard/project/zkririyknhlwoxhsoqih';
  static const String storageUrl = 'https://zkririyknhlwoxhsoqih.supabase.co/storage/v1/s3';
}
```
